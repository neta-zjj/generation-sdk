...
function buildResult(operation: string, task: SunoTaskDto, raw: unknown): GenerationAdapterResult {
...
export async function sunoTasksAdapter(input: GenerationAdapterInput): Promise<GenerationAdapterResult> {
