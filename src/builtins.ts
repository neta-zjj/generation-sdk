...
const builtinModels = [
  ...
  },
  {
    ...
    category: "video",
    description: "MiniMax H3 video generation with provider-defined output dimensions.",
    adapter: {
      type: "minimax.h3VideoGenerations",
      upstream_model: "MiniMax-H3-unrestricted",
    },
    content: { input: minimaxH3ContentInput },
    parameters: minimaxH3VideoParameters(),
    examples: [
      {
        ...
        request: {
          model: "minimax-h3-unrestricted",
          content: [{ type: "text", text: "a red cube rotating on a white table" }],
          parameters: { duration: 15, resolution: "4K", ratio: "16:9" },
        },
      },
    ],
  },
